  ...
  public void setUp(TestContext context) throws Exception {
    ...
    server.requestHandler(req -> {
      if (req.path().equals("/rm/rmaccounts/test/titles")) {
        if ("search=moby%2520dick&searchfield=titlename&orderby=titlename&count=5&offset=1".equals(req.query())) {
        ...
        } else if ("search=moby%2520dick&searchfield=titlename&orderby=titlename&count=5&offset=2".equals(req.query())) {
        ...
        } else if ("search=moby%2520dick&searchfield=titlename&orderby=titlename&count=10&offset=1".equals(req.query())) {
        ...
        } else if ("search=moby%2520dick&searchfield=titlename&orderby=titlename&count=10&offset=2".equals(req.query())) {
